                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '
                            ...
                            <td>' . $iStkAlert . '</td>
                            <td>
                                <a href="inven-mng-update.php?invenupdateid=' . $no . '"style="background-color: rgb(0, 33, 91);
                                                                                        padding:5px; 
                                                                                        color: white; 
                                                                                        border: 1px solid black; 
                                                                                        border-radius: 8px; 
                                                                                        text-decoration: none;">Update</a>
                                <a href="inven-mng-delete.php?deleteid=' . $no . '"style="background-color: rgb(0, 33, 91);
                                                                                    padding:5px; 
                                                                                    color: white; 
                                                                                    border: 1px solid black; 
                                                                                    border-radius: 8px; 
